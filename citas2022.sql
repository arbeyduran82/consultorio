...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-09-2022 a las 00:46:20
...
INSERT INTO `citas` (`codCita`, `tipoCita`, `fechaCita`, `horaCita`, `Estado`, `Observaciones`, `codConsultorio`, `codMedico`, `codPaciente`) VALUES
(1, 'Medicina interna', '2022-09-10', '19:17:00', 'Activa', 'Ninguna', 101, 79989560, 45546666);
...
INSERT INTO `pacientes` (`documentoP`, `nombreP`, `apellidoP`, `emailP`, `fechaNac`, `generoP`) VALUES
(45546666, 'Julian', 'Giraldo Galindo', 'giraldo.julian@gmail.com', '1985-09-15', 'Masculino');
...
(2, 'Carlos', 'Otro', 'otro@gmail.com', '123456789', 'medico'),
(3, 'Josue', 'Carrasquilla', 'carrasquilla.josue@misena.edu.co', '123456789', 'auxiliar');
...
--
ALTER TABLE `citas`
  MODIFY `codCita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
